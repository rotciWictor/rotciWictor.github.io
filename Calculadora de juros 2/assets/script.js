...
function sortClientName() {
    ...
    database.forEach((element, i) => {
        ...
        document.getElementById(`client-name${i}`).innerHTML = element.clientName
        document.getElementById(`due-date${i}`).innerHTML = element.dueDate
        document.getElementById(`value${i}`).innerHTML = element.pucharseAmount
        document.getElementById(`actual-value${i}`).innerHTML = `R$ ${element.actualValue.toFixed(2)}`
